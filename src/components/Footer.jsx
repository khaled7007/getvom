      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="border-t border-gray-800 pt-8 pb-6">
          <div className="flex flex-wrap items-center gap-3">
            ...
            {/* App Store */}
            <a href="https://apps.apple.com" target="_blank" rel="noopener noreferrer" className="bg-gray-800 hover:bg-gray-700 rounded px-3 py-1 h-7 flex items-center gap-1.5 transition-colors">
            ...
            {/* Google Play */}
            <a href="https://play.google.com" target="_blank" rel="noopener noreferrer" className="bg-gray-800 hover:bg-gray-700 rounded px-3 py-1 h-7 flex items-center gap-1.5 transition-colors">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 text-white flex-shrink-0">
                <path d="M3.18 23.76c.3.17.64.24.99.2L15.77 12 12 8.23 3.18 23.76zM20.73 10.23l-2.79-1.6-3.44 3.44 3.44 3.44 2.8-1.61c.8-.46.8-1.21-.01-1.67zM2.1.26C1.8.46 1.6.8 1.6 1.24v21.52c0 .44.2.78.5.98L14 12 2.1.26zM15.77 12L3.18.24c-.1-.06-.2-.1-.3-.13L12 8.23l3.77 3.77z" />
              </svg>
              <span className="text-[11px] text-gray-300">Google Play</span>
            </a>
          </div>
        </div>
